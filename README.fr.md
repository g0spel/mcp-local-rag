...
| `HF_ENDPOINT` | Non disponible | `https://huggingface.co` | Adresse de téléchargement des modèles. Indiquez l'URL de votre miroir Hugging Face si les téléchargements directs sont bloqués. |
