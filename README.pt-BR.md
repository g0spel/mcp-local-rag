...
| `HF_ENDPOINT` | N/D | `https://huggingface.co` | Endereço para download de modelos. Use a URL do seu espelho do Hugging Face quando downloads diretos estiverem bloqueados. |
